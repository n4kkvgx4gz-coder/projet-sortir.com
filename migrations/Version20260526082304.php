 ...
 */
final class Version20260526082304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE groupe_prive (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, createur_id INT NOT NULL, INDEX IDX_A8D00A9D73A201E5 (createur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE groupe_prive_utilisateur (groupe_prive_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_5313A586EFB6D465 (groupe_prive_id), INDEX IDX_5313A586FB88E14F (utilisateur_id), PRIMARY KEY (groupe_prive_id, utilisateur_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE sortie ADD CONSTRAINT FK_3C3FD3F2D936B2FA FOREIGN KEY (organisateur_id) REFERENCES utilisateur (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE groupe_prive_utilisateur');

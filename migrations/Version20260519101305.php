 ...
 */
final class Version20260519101305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription ADD id INT AUTO_INCREMENT NOT NULL, ADD sortie_id INT NOT NULL, ADD user_id INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription DROP id, DROP sortie_id, DROP user_id, DROP PRIMARY KEY, ADD PRIMARY KEY (id_sortie, id_participant)');
